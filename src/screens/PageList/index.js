...
const PageList = () => {
  return (
    <div className={styles.page} style={{ fontSize: 16, fontWeight: 500 }}>
      ...
      <p style={{ marginBottom: 5 }}>
        <Link to="/products/drafts">Estimate</Link>
      </p>
      <p style={{ marginBottom: 5 }}>
        <Link to="/products/released">Active</Link>
      </p>
      <p style={{ marginBottom: 5 }}>
        <Link to="/products/comments">Beneficiaries</Link>
      </p>
      <p style={{ marginBottom: 5 }}>
        <Link to="/products/scheduled">Claims</Link>
      </p>
      <p style={{ marginBottom: 5 }}>
        <Link to="/customers/overview">Users</Link>
      </p>
      <p style={{ marginBottom: 5 }}>
